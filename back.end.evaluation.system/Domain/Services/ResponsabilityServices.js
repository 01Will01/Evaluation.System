...
ResponsabilityServices.prototype.Include = async(req, res, _responsabilityRepository) => {
...
ResponsabilityServices.prototype.ControlRelationResponsibilityArea = async(req, res, _responsabilityRepository) => {
...
ResponsabilityServices.prototype.ControlRelationResponsibilityPermission = async(req, res, _responsabilityRepository) => {
    let list = req.body.relation
...
ResponsabilityServices.prototype.GetResponsibilityPermission = async(res, _responsabilityRepository) => {
...
ResponsabilityServices.prototype.GetPermission = async(res, _responsabilityRepository) => {
...
ResponsabilityServices.prototype.Get = async(res, _responsabilityRepository) => {
    let data = await _responsabilityRepository.Get();
    res.json(_shared.NotificationTemplate(true, data, "Lista de cargos cadastrados!"));
};

ResponsabilityServices.prototype.Activate = async(req, res, _responsabilityRepository) => {
...
ResponsabilityServices.prototype.Disable = async(req, res, _responsabilityRepository) => {
    let statusDisable = 2;
